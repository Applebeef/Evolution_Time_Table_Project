...
@WebServlet("/pages/tablePage/update_engine")
public class UpdateEngineDetails extends HttpServlet {
    @Override
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        EngineData engineData = new EngineData(crossovers, selections, mutations, frequency);

        // Save thread at TimeTable:
        descriptorManager.getDescriptor(index).updateEngineDetails(user, crossoverWrapperList, selectionsList, mutationWrapperList);
    }
